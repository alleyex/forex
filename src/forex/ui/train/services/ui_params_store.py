...
class UIParamsStore:
    ...
    _LEGACY_KEYS = {
        "training": {
            ...
            "curriculum_enabled",
            "curriculum_steps",
            "curriculum_max_position",
            "curriculum_position_step",
            "curriculum_min_position_change",
            "vf_coef",
            "n_epochs",
            "episode_length",
            "eval_split",
            "save_best_checkpoint",
            "checkpoint_min_trade_rate",
            "checkpoint_max_trade_rate",
            "checkpoint_max_flat_ratio",
            "checkpoint_max_ls_imbalance",
            "checkpoint_max_drawdown",
            ...
            "anti_flat_enabled",
            "anti_flat_warmup_steps",
            "anti_flat_patience_evals",
            "anti_flat_min_trade_rate",
            "anti_flat_max_flat_ratio",
            "anti_flat_max_ls_imbalance",
            "anti_flat_profile_steps",
            "eval_profile_steps",
            "eval_profile_min_trade_rate",
            "eval_profile_max_flat_ratio",
            "eval_profile_max_ls_imbalance",
            "optuna_trials",
            "optuna_steps",
            "optuna_auto_select",
            "optuna_select_mode",
            ...
            "optuna_replay_walk_forward_segments",
            "optuna_replay_walk_forward_steps",
            "optuna_replay_walk_forward_stride",
