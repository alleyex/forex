...
from ui_train.dialogs.history_download_dialog import HistoryDownloadDialog
from ui_train.state.history_download_state import HistoryDownloadState
from ui_train.utils.formatters import format_history_message
